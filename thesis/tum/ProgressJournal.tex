...
\hline
\multirow{2}{*}{\textbf{Criteria}} & \multicolumn{3}{c|}{\textbf{Datasets}} \\ \cline{2-4} 
 & \textbf{Dataset 1} & \textbf{Dataset 2} & \textbf{Dataset 3} \\ \hline
\textbf{Modalities} & MR, SEG & MR, CT & PET, CT \\ \hline
\textbf{Participants} & 500 & 750 & 300 \\ \hline
\textbf{Studies} & 250 & 400 & 150 \\ \hline
\textbf{Series} & 1,500 & 2,000 & 800 \\ \hline
\textbf{Images} & 100,000 & 150,000 & 60,000 \\ \hline
\textbf{Image Size (GB)} & 50.0 & 75.0 & 30.0 \\ \hline
\end{tabular}
\end{table}
